...
import { createShortUrl, deleteLink, getAllUserLinks, getLinkAnalytics, getLinksDetails, redirectToOriginalUrl, updateLink } from "../controllers/link.controller";
...
linkRoutes.put('/user/links/:id',protect,updateLink);
